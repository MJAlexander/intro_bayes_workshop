---
title: "Introduction to Bayesian Models for Demographers"
author: "Monica Alexander"
format: pdf
number-sections: true
subtitle: "Summer Incubator Workshop, 6 June 2023"
toc: true
execute: 
  echo: true
  warning: false
...
This Quarto document illustrates how to fit a Gompertz mortality model in a Bayesian framework using Stan. We will be using data from the Canadian HMD as an example. 
...
What is the output we're actually interested in? The posterior samples. The 'classic' way of extracting using functions from te rstan package:
